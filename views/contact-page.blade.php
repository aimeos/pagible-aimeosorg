...
<div class="aimeos-contact-page">
    ...
    <section class="contact-band contact-form-band contact">
        <div class="container">
            ...
            <form action="{{ cmsroute('cms.api.contact') }}" method="POST" aria-describedby="contact-errors-{{ $formId }}" toolname="contact" tooldescription="{{ __('Send a message to the site owner through the contact form') }}">
